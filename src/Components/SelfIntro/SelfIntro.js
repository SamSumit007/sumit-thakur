        ...
        <Row>
          <Col md={16} className="home-about-description">
            ...
            <p className="home-about-body">
              Hi,👋 I'm <span style={{color: "#0A81AB" , fontStyle:"italic"}}>Sumit Thakur</span> an aspiring and determined <span style={{color: "#0A81AB" , fontStyle:"italic"}}>Full Stack Web Developer</span>, curious to explore different industry-standard tech stacks and environments.
